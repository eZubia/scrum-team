...
// Crear un nuevo adaptador
    ...
    public ArrayList<Project> getProyectosManager(String idUsuario){
        ConnectServerManager server = new ConnectServerManager();
    ...
    public class ConnectServerManager extends AsyncTask<String, Integer, String> {
        @Override
        protected String doInBackground(String... parameters) {
            String json = ReadProyectos.findProyectosManager(parameters[0]);
